...
- "Wound_healing_MRC5_toci.xlsx": Sheet 2. Raw data used to quantify the wound healing assay in MRC5 cells with BALF from MV or CPAP patients treated with tocilizumab.
